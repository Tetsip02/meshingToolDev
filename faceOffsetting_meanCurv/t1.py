...
# ref_points = np.concatenate((surface_points, level2))
...
refMesh = meshio.Mesh(points = d, cells = level2Surface)
meshio.write("./output/refMesh.vtk", refMesh, file_format="vtk", binary=False)
