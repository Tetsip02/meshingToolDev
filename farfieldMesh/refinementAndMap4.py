...
#seeding several starting cells:
...
if numIter == 0:
    ...
    print("restart search from new seeding cell among cells that haven't been checked yet")
    level3_not_checked = np.arange(level3_mesh.shape[0])
    level3_not_checked = np.delete(level3_not_checked, level3_checked)
    level3_midpoints_not_checked = level3_midpoints[level3_not_checked]
...
# mesh = meshio.Mesh(points = all_points, cells = voxel1)
# meshio.write("./l3_targets.vtk", mesh, file_format="vtk", binary=False)
